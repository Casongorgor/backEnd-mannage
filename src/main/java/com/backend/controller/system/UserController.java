...
import com.backend.plugin.PageView;
import com.backend.util.Common;
import com.backend.util.JsonUtils;
import com.backend.util.POIUtils;
import com.backend.util.PasswordHelper;
...
public class UserController extends BaseController {
	 ...
	 * 验证账号是否存在
	 * 
	 *  Email：mmm333zzz520@163.com date：2014-2-19
	 * @param name
	 * @return
	 */
